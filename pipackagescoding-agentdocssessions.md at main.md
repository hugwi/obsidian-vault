...
categories:
  - "[[Resources]]"
domain: engineering
title: "pi/packages/coding-agent/docs/sessions.md at main"
source: "https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/sessions.md"
author:
published:
created: 2026-06-10
description: "AI agent toolkit: unified LLM API, agent loop, TUI, coding agent CLI - pi/packages/coding-agent/docs/sessions.md at main · earendil-works/pi"
tags:
  - "to-process"
  - agent-tools
---
...
For the JSONL file format and SessionManager API, see [Session Format](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/session-format.md).
...
| `/compact [prompt]` | Summarize older context; see [Compaction](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/compaction.md) |
...
[![Tree View](https://github.com/earendil-works/pi/raw/main/packages/coding-agent/docs/images/tree-view.png)](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/images/tree-view.png)
...
Filter modes are: default, no-tools, user-only, labeled-only, and all. Configure the default with `treeFilterMode` in [Settings](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/settings.md).
...
See [Compaction](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/compaction.md) for branch summarization internals and extension hooks.
...
For parsers, extensions, SDK usage, and the full SessionManager API, see [Session Format](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/session-format.md).