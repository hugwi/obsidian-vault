...
categories:
  - "[[Resources]]"
domain: engineering
title: "DeusData/codebase-memory-mcp: High-performance code intelligence MCP server. Indexes codebases into a persistent knowledge graph — average repo in milliseconds. 66 languages, sub-ms queries, 99% fewer tokens. Single static binary, zero dependencies."
source: "https://github.com/DeusData/codebase-memory-mcp"
author:
  - "[[GitHub]]"
published:
created: 2026-04-08
description: "High-performance code intelligence MCP server. Indexes codebases into a persistent knowledge graph — average repo in milliseconds. 66 languages, sub-ms queries, 99% fewer tokens. Single static binary, zero dependencies. - DeusData/codebase-memory-mcp"
tags:
  - raw  - agent-plugins-mcp
---
## codebase-memory-mcp
