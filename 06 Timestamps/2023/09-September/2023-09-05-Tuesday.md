---
created: 2023-09-05 09:24
---
tags:: [[+Daily Notes]]

# Tuesday, September 05, 2023

<< [[2023-09-04-Monday|Yesterday]] | [[2023-09-06-Wednesday|Tomorrow]] >>
...
- [ ] Fix data acces not propagating
 ...
 - [ ] Create data validation
	 - Minimal example how the data can be validated - format of data, how to select subset
...
We have a lot of merge conflict with Datahub and there is problem with kafka and elasticsearch - elasticsearch doesn't correctly create some indices. Xuelei is not optimistic 
