---
title: "pi/packages/coding-agent/docs/compaction.md at main"
source: "https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/compaction.md"
author:
published:
created: 2026-06-09
description: "AI agent toolkit: unified LLM API, agent loop, TUI, coding agent CLI - pi/packages/coding-agent/docs/compaction.md at main · earendil-works/pi"
tags:
  - "to-process"
  - agent-tools
---
