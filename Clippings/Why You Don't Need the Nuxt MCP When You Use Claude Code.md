...
![rw-book-cover](https://alexop.dev/posts/why-you-dont-need-the-nuxt-mcp-when-you-use-claude-code/index.png)

## Metadata
- Author: [[Alexander Opalic]]
- Full Title: Why You Don't Need the Nuxt MCP When You Use Claude Code
- Category: #articles
- Summary: Nuxt’s Model Context Protocol (MCP) causes context bloat and is less efficient for up-to-date AI assistance. Instead, using custom research agents that fetch current docs via llms.txt keeps context small and answers accurate. This method, used by Claude Code, works well for Nuxt Content v3 by loading only needed info without bloating the main AI context.
- URL: https://alexop.dev/posts/why-you-dont-need-nuxt-mcp-claude-code/
