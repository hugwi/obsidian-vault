...
![rw-book-cover](https://cdn.thenewstack.io/media/2026/06/d254e45d-fast-ink-ckc2h0pujxs-unsplash-scaled.jpg)

## Metadata
- Author: [[Ankit Jain]]
- Full Title: How long before we stop reading the code?
- Category: #articles
- Summary: Code reviews are slowing down development because AI writes code faster than humans can read it. Instead of checking code line-by-line, teams should review the intent and plans before coding begins. Using automated checks for standards and tests lets humans focus on important judgment calls, making reviews faster and better.
- URL: https://thenewstack.io/future-of-code-reviews/

## Full Document
![Featued image for: How long before we stop reading the code?](https://cdn.thenewstack.io/media/2026/06/d254e45d-fast-ink-ckc2h0pujxs-unsplash-1024x584.jpg)Fast Ink for Unsplash+
...
![Summary slide of what code review used to be, and what it becomes](https://cdn.thenewstack.io/media/2026/06/4bde9091-image2-1024x576.png)Summary slide of what code review used to be, and what it becomes
...
![Workflow steps to change the shape of code reviews](https://cdn.thenewstack.io/media/2026/06/f4d062b8-image1-1024x576.png)Workflow steps to change the shape of code reviews
