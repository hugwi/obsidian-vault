...
![A file system tree, with a single root folder called src and then seven subfolders: app, processes, pages, widgets, features, entities, shared. The processes folder is slightly faded out.](https://feature-sliced.design/img/layers/folders-graphic-light.svg#light-mode-only)
...
Learn more about the `@x` notation in the [Public API for cross-imports](https://feature-sliced.design/docs/reference/public-api#public-api-for-cross-imports) section.
