...
![rw-book-cover](https://opengraph.githubassets.com/b73927e842d7d5a05c2e7c482e838995042f338fbe4447aa00d1c40cd4b721c8/millionco/react-doctor)

## Metadata
- Author: [[https://github.com/millionco/]]
- Full Title: GitHub - millionco/react-doctor: Let coding agents diagnose and fix your React code
- Category: #articles
- Summary: React Doctor is a tool that scans React code for problems like security and performance issues. It gives a score from 0 to 100 and shows how to fix the problems. You can use it with one command or add it to coding agents like Copilot to improve your React projects.
