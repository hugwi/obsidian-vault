...
![rw-book-cover](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/05/lfm2-5-1-2b-in-lm-studio-on-desktop-pc-lego-and-lamp-in-view.jpeg?w=1600&h=900&fit=crop)

## Metadata
- Author: [[Nolen Jonker]]
- Full Title: I tested 3 tiny local LLMs for everyday work, and only one of them impressed me
- Category: #articles
- Summary: The author tested three very small local language models for everyday tasks and found only one truly useful. Gemma 4 E2B handled structured tasks well but had quirks, while Qwen 3.5 0.8B was confidently wrong often. LFM2.5-1.2B was poor at creative tasks but reliable and accurate for real-time data and specialized uses.
- URL: https://www.xda-developers.com/tested-tiny-local-llms-for-everyday-work-only-one-impressed-me/
