...
![rw-book-cover](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/03/claude-code.jpg?w=1600&h=900&fit=crop)

## Metadata
- Author: [[Shekhar Vaidya]]
- Full Title: 4 Claude Code slash commands I use daily that make me more productive
- Category: #articles
- Summary: Claude Code’s slash commands help users work faster by controlling models, managing servers, and handling memory efficiently. Commands like /model, /mcp, /memory, /context, and /agents let you switch tasks, monitor systems, and run parallel workflows easily. Using these commands changes Claude from a simple chatbot into a powerful tool that improves daily productivity.
- URL: https://www.xda-developers.com/claude-code-slash-commands-use-daily-more-productive/
