...
# Automating e2e / manual labor with Claude Code

![rw-book-cover](https://media.licdn.com/dms/image/v2/D5612AQEDCMf6K2Sopg/article-cover_image-shrink_720_1280/B56ZuohDyqHUAI-/0/1768058800309?e=2147483647&v=beta&t=JV-IaV_0wsYkD8NuJBfd4ENU-pyXhqLR7f92MZNeaTQ)

## Metadata
- Author: [[Ariel Beck]]
- Full Title: Automating e2e / manual labor with Claude Code
- Category: #articles
- Summary: Claude Code lets you write end-to-end tests using plain English instead of code. It runs tests by controlling the browser and checking results automatically. This method is good for complex flows but slower and costlier than traditional testing tools.
- URL: https://www.linkedin.com/pulse/automating-e2e-manual-labor-claude-code-ariel-beck-k1hac/
