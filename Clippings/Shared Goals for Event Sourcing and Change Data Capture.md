...
![rw-book-cover](https://debezium.io/assets/images/color_black_debezium_type_1200px.png)

## Metadata
- Author: [[Debezium]]
- Full Title: Shared Goals for Event Sourcing and Change Data Capture
- Category: #articles
- Summary: Event Sourcing and Change Data Capture (CDC) both track data changes as events but use different sources of truth. CDC with the Outbox Pattern offers strong consistency, simpler design, and better reliability for microservices. While Event Sourcing can be useful, CDC and Outbox with Debezium are often better choices for building distributed systems.
...
Taking a quick step back, Event Sourcing and Change Data Capture are solutions that can be used to build distributed systems (i.e. microservices) that are Reactive. Microservices should react to an ever-changing environment (i.e. the cloud) by being resilient and elastic. The magic behind these abilities is being message and event driven. To find out more, I advise you to read the [Reactive Manifesto](https://www.reactivemanifesto.org/).

![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure01.png)
...
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure02.png)
...
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure03.png)
...
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure04.png)
...
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure05.png)
...
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure06.png)
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure07.png)
...
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure08.png)
...
| --- | --- | --- | --- | --- |
| **Purpose** | Capture state in a journal containing domain events. | Export Change Events from transaction log. | Export domain events from an Outbox via CDC. | Use domain events to generate projections of data. |
| **Event Type** | Domain Event | Change Event | Domain Event embedded in Change Event | Domain Event |
| **Source of Truth** | Journal | Transaction Log | Transaction Log | Depends on implementation |
| **Boundary** | Application | System | System (CDC) Application (Outbox) | Application or System |
| **Consistency Model** | N/A (only writing to the Journal) | Strongly Consistent (tables), Eventually Consistent (Change Event capture) | Strongly Consistent (Outbox), Eventually Consistent (Change Event capture) | Eventually Consistent |
| **Replayability** | Yes | Yes | Yes | Depends on implementation |
...
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure09.png)
...
![](https://debezium.io/assets/images/2020-02-06-event-sourcing-vs-cdc/figure10.png)
...
Some content could not be imported from the original document. [View content ↗](https://disqus.com/recommendations/?base=default&f=debezium&t_u=https%3A%2F%2Fdebezium.io%2Fblog%2F2020%2F02%2F10%2Fevent-sourcing-vs-cdc%2F&t_d=Distributed%20Data%20for%20Microservices%20%E2%80%94%20Event%20Sourcing%20vs.%20Change%20Data%20Capture&t_t=Distributed%20Data%20for%20Microservices%20%E2%80%94%20Event%20Sourcing%20vs.%20Change%20Data%20Capture#version=af5dcff7c80ddb6cb8b656857138adf1) 

Some content could not be imported from the original document. [View content ↗](https://disqus.com/embed/comments/?base=default&f=debezium&t_i=https%3A%2F%2Fdebezium.io%2Fblog%2F2020%2F02%2F10%2Fevent-sourcing-vs-cdc%2F&t_u=https%3A%2F%2Fdebezium.io%2Fblog%2F2020%2F02%2F10%2Fevent-sourcing-vs-cdc%2F&t_d=Distributed%20Data%20for%20Microservices%20%E2%80%94%20Event%20Sourcing%20vs.%20Change%20Data%20Capture&t_t=Distributed%20Data%20for%20Microservices%20%E2%80%94%20Event%20Sourcing%20vs.%20Change%20Data%20Capture&s_o=default#version=4f6c84d9c117966654eabd9c43811df4)
