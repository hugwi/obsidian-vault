...
If you use macOS, [Hammerspoon](https://www.hammerspoon.org/), and [Ghostty](https://ghostty.org/), see [`examples/hammerspoon/ghostty-fn.lua`](https://github.com/renjfk/opencode-voice/blob/main/examples/hammerspoon/ghostty-fn.lua) for an optional global `Fn` key setup.
...
Manual releases via opencode; see [RELEASE\_PROCESS.md](https://github.com/renjfk/opencode-voice/blob/main/RELEASE_PROCESS.md).

## License

This project is licensed under the [MIT License](https://github.com/renjfk/opencode-voice/blob/main/LICENSE).