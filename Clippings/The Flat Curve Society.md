...
![rw-book-cover](https://miro.medium.com/v2/resize:fit:1400/1*41EEUrrzzmBVn8-UZ9oGjA.jpeg)

## Metadata
- Author: [[Steve Yegge]]
- Full Title: The Flat Curve Society
- Category: #articles
- Summary: AI development is slowing as powerful models become restricted and costly, limiting access to only a few. Most people and companies will use current AI tools, which are helpful but not yet revolutionary. To succeed, organizations must train employees in AI skills and overcome resistance to change.
- URL: https://steve-yegge.medium.com/the-flat-curve-society-36c8b01eb33b

## Full Document
![](https://miro.medium.com/v2/resize:fit:1400/1*41EEUrrzzmBVn8-UZ9oGjA.jpeg)The Flat Curve SocietyHi-ho, we’ve reached the moment, in this movie we’re all watching together on X, where model intelligence has become dangerous. Dario predicted years ago that it would happen this year. With Fable being (briefly) shut off by the USG, it’s the first highly visible sign that we’ve crossed into treacherous waters.
...
Some people are already reporting they can’t tell the difference between Opus 4.8 and Fable 5. I’ve been calling this the “discernment horizon”: every human has a ceiling on model intelligence past which all the models start to feel about the same. But there are actually two ceilings, both instructive.

The first I’ll call the demand horizon. It’s set by the hardest problem you bring. If all you have handy are easy problems, they don’t give a smarter model any room to pull ahead — the outputs look the same because the problem never stretched either one.
...
The demand horizon is where you can’t tell two models apart because you don’t have a hard enough problem. That is benign enough, even kind of flattering: it just means your work isn’t hard enough right now. But bring an unusually hard problem one day, and your horizon widens on the spot, as you watch the cheaper model fumble some task the expensive one nails. Like my React client.

There is a darker horizon, which I think of as the discernment horizon. This one is set not by the hardest problem you can pose, but by the hardest answer you can judge. Past this scary line, you can’t tell whether the model is right, because checking the work is itself beyond you.
...
![](https://miro.medium.com/v2/resize:fit:1400/1*SF1BasFag8DKAfmOsuzaig.jpeg)The Discernment HorizonThis takes us full circle to *why* they are starting to lock down the models. You can’t hand out an intelligence engine that nobody can supervise. It’s pointless to own because you won’t know if it’s helping you or walking you off a cliff. Superhuman *means* unverifiable.
...
![](https://miro.medium.com/v2/resize:fit:1400/1*7FvNDJkCUQ_Af7umgoN-BA.jpeg)Vibe Coding WorkshopsI watched a mind-blowing presentation in April from Ezra Savard, who ran a training study/experiment at Netflix from December through March. He gave the presentation at Gene Kim’s AI Summit in San Jose. The study’s goal was to train Netflix engineers on agentic coding, and measure the impact.
...
![](https://miro.medium.com/v2/resize:fit:1400/1*e3RNtiUi6e-koK0oYV0vHQ.jpeg)The journey from beginner to masterToken spend only signals literacy on the way up. It’s a skill you build. But then it flips, and the thing you need to start measuring is token waste. Minimizing that is another set of skills.
...
![](https://miro.medium.com/v2/resize:fit:1400/1*l3vx3p6UiFCzQ43cDmE_JA.jpeg)Campground Craft
