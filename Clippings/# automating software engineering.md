...
- Full Title: # automating software engineering
- Category: #tweets
- Summary: Automating software engineering is likened to the progression of self-driving technology, where AI gradually takes over tasks previously done by humans with oversight. In software engineering, this evolution involves manual coding, then tools like GitHub Copilot and ChatGPT assisting in code completion. The future likely entails coordinating various tools to write code, with humans overseeing and providing high-level guidance to the AI. This shift signifies a significant transformation in software engineering, resembling supervision of automation with human input in high-level strategies and commands.
- URL: https://x.com/karpathy/status/1767598414945292695/?rw_tt_thread=True
