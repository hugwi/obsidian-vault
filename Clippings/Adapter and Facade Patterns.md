...
## Metadata
- Author: [[Robert Gu]]
- Full Title: Adapter and Facade Patterns
- Category: #articles
- Summary: The adapter pattern lets your app wrap and convert third-party APIs so different classes can talk to each other. The facade pattern gives one simple interface that combines functions across many services for easy, high-level tasks. Both patterns make code modular and protect your app from API changes.
- URL: https://medium.com/@BobGuBobGu/adapter-and-facade-patterns-8b05e00a29a3
