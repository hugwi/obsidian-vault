...
![rw-book-cover](https://developers.openai.com/images/blog/eval-skills.png)

## Metadata
- Author: [[openai.com]]
- Full Title: Testing Agent Skills Systematically with Evals | OpenAI Developers
- Category: #articles
- Summary: Agent skills are sets of prompts and instructions for large language models that need careful testing to work well. Using evals means running the skill, recording what happens, and scoring it with clear checks to catch problems or improvements. This process helps make skill behavior reliable and repeatable over time.
...
Copy Page 
 ...
 ![Testing Agent Skills Systematically with Evals](https://developers.openai.com/images/blog/eval-skills.png) 
