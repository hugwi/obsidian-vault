...
![rw-book-cover](https://deloughry.co.uk/og-image/webmcp-the-web-just-got-a-bit-smarter.png)

## Metadata
- Author: [[Matthew Peck-Deloughry]]
- Full Title: WebMCP — The Web Just Got a Bit Smarter (Whether It Wanted To or Not)
- Category: #articles
- Summary: WebMCP is a new browser API from Google that lets websites share their functions directly with AI agents in a clear, structured way. This helps AI interact with sites smoothly, avoiding slow guessing or errors. Though still early and needing careful security work, WebMCP promises smarter web-AI cooperation and better accessibility soon.
- URL: https://deloughry.co.uk/posts/webmcp-the-web-just-got-a-bit-smarter/
