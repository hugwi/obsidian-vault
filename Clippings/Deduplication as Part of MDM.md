...
![rw-book-cover](https://liliendahl.com/wp-content/uploads/2021/03/deduplication-as-part-of-mdm.png)

## Metadata
- Author: [[Liliendahl on Data Quality]]
- Full Title: Deduplication as Part of MDM
- Category: #articles
- Summary: Deduplication is a key link between Data Quality Management and Master Data Management. It finds and links records for the same person, organization, product, or asset and creates golden records or links. Linked records also form hierarchies (family, company, product) that improve operations and analytics.
- URL: https://liliendahl.com/2021/03/17/deduplication-as-part-of-mdm/
