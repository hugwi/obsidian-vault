...
![rw-book-cover](https://miro.medium.com/v2/resize:fit:1200/1*X68DND6Lh8GFvM3i49KOhA.png)

## Metadata
- Author: [[Erik D. Kennedy]]
- Full Title: 7 Rules for Creating Gorgeous UI
- Category: #articles
- Document Tags: [[design]] 
- Summary: The article "7 Rules for Creating Gorgeous UI" by Erik D. Kennedy offers practical tips for developers and UX designers looking to improve their interface design skills. It emphasizes the importance of starting with black and white designs, using ample whitespace, and understanding the basics of lighting and typography. The guide aims to help designers create visually appealing and effective user interfaces without needing an art background.
