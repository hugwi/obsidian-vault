...
![rw-book-cover](https://opengraph.githubassets.com/c2dd5eab9a94393bddde333cc85ac0c7228cb92fe69a930aa898c10dc78f4966/dynaptik/crispy)

## Metadata
- Author: [[https://github.com/dynaptik/]]
- Full Title: dynaptik/crispy: CRISPY (how QRSPI sounds to me phonetically) is a multi-agent orchestration plugin for agentic AI coding. It implements an 8-phase state machine based on the QRSPI methodology (Question, Research, Structure, Plan, Implement).
- Category: #articles
- Summary: CRISPY is a plugin for VS Code that helps AI agents work together to write code using an 8-step process called QRSPI. It breaks development into small, testable parts and controls how agents share information to keep work clear and focused. The plugin supports git and guides users through design approval and implementation in a structured way.
- URL: https://github.com/dynaptik/crispy
