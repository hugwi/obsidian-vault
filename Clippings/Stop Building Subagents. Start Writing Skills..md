...
- Full Title: Stop Building Subagents. Start Writing Skills.
- Category: #articles
- Summary: Subagents use up lots of context by loading everything at once, while skills load only what’s needed, saving space and complexity. Skills are easy to manage, discover automatically by project, and work across many AI tools as portable expertise. Use skills first and only switch to subagents when you need isolated or parallel tasks.
- URL: https://alexlavaee.me/blog/skills-over-subagents/
