...
![rw-book-cover](https://blog.can.ac/2026/02/12/the-harness-problem/og.png)

## Metadata
- Author: [[Can Bölük]]
- Full Title: I Improved 15 LLMs at Coding in One Afternoon. Only the Harness Changed.
- Category: #articles
- Summary: Improving the tool that helps models edit code can boost their performance more than changing the model itself. A new method using line hashes made editing more accurate and efficient across many models. Open, community-built tools are key to solving this problem, not just private company solutions.
