...
![rw-book-cover](https://blog.fsck.com/)

## Metadata
- Author: [[fsck.com]]
- Full Title: Using GraphViz for CLAUDE.md
- Category: #articles
- Summary: The author and Claude used GraphViz (.dot) as a readable process-spec language and iterated until flows were clear. Dot made rules visual, searchable, versionable, and easier for Claude to follow. They propose a modular process library of focused .dot files for reuse.
- URL: https://blog.fsck.com/2025/09/29/using-graphviz-for-claudemd/
