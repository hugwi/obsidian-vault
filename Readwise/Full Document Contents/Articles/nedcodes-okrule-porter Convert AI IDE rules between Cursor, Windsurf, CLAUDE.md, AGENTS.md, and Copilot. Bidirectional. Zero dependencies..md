...
![rw-book-cover](https://repository-images.githubusercontent.com/1168813773/da6a9046-3994-4030-ad83-796125b8fe9d)

## Metadata
- Author: [[https://github.com/nedcodes-ok/]]
- Full Title: nedcodes-ok/rule-porter: Convert AI IDE rules between Cursor, Windsurf, CLAUDE.md, AGENTS.md, and Copilot. Bidirectional. Zero dependencies.
- Category: #articles
- Summary: Rule-porter converts AI IDE rules between different formats like Cursor, Claude, Copilot, Windsurf, and AGENTS.md. It works bidirectionally with zero dependencies and preserves most rule details. Users can preview changes and check their rules after conversion for errors.
