# GitHub - mikaelvesavuori/github-dora-metrics: Instant, badge-ready DORA metrics for your GitHub repository. · GitHub

![rw-book-cover](https://opengraph.githubassets.com/517ea1bc20773b4f01a8ba634a09bfbd4c3ed5fb4c6f1a39b728858aba91d15c/mikaelvesavuori/github-dora-metrics)

## Metadata
- Author: [[https://github.com/mikaelvesavuori/]]
- Full Title: GitHub - mikaelvesavuori/github-dora-metrics: Instant, badge-ready DORA metrics for your GitHub repository. · GitHub
- Category: #articles
- Summary: This project provides an AWS-based service that calculates DORA metrics for GitHub repositories using repository data. It supports personal access tokens for private repos and can generate badge-ready metric summaries. The tool uses GitHub deployments and issues to estimate key performance metrics like deployment frequency and change failure rate.
- URL: https://github.com/mikaelvesavuori/github-dora-metrics#change-failure-rate
...
* [Change failure rate (CFR)](https://github.com/mikaelvesavuori/github-dora-metrics/#change-failure-rate)
* [Deployment frequency (DF)](https://github.com/mikaelvesavuori/github-dora-metrics/#deployment-frequency)
* [Lead time to change (LTC)](https://github.com/mikaelvesavuori/github-dora-metrics/#lead-time-for-changes)
* [Mean time to repair (MTTR)](https://github.com/mikaelvesavuori/github-dora-metrics/#mean-time-to-repair)
...
*Please note that it's kind of messy to sometimes calculate these values strictly to their intended use. Read more about the details of these in the [Calculations](https://github.com/mikaelvesavuori/github-dora-metrics/#calculations) section and how this solution adapts some shortcomings in the available data.*
...
*See [this guide for how to create a personal access token](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token).*
...
*Quotes from [a blog post on Google Cloud](https://cloud.google.com/blog/products/devops-sre/using-the-four-keys-to-measure-your-devops-performance).*
