...
![rw-book-cover](https://opengraph.githubassets.com/26ff17f3db2c03532aa5ee6bd42ce0b97e9b85243cdde21a2ecc4c17c48a0ee3/stride-nyc/ohl-agent)

## Metadata
- Author: [[https://github.com/stride-nyc/]]
- Full Title: stride-nyc/ohl-agent: ReAct agent with MCP for OneHealthLink agent escalation
- Category: #articles
- Summary: This project builds a ReAct agent that uses a structured state system and tools to analyze conversations and suggest responses quickly. It connects a LangGraph server with an MCP gateway to access local and external tools, including documentation and memory servers. The design allows easy switching of AI providers, clear state management, and faster response times without extra MCP calls during reasoning.
- URL: https://github.com/stride-nyc/ohl-agent

## Full Document
[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/stride-nyc/ohl-agent?resume=1) 

#### Create list

### stride-nyc/ohl-agent
...
This branch is [32 commits ahead of](https://github.com/stride-nyc/ohl-agent/compare/danmas0n%3Areact-agent-with-mcp%3Amain...main) danmas0n/react-agent-with-mcp:main.
...
* **conversation\_history**: Messages between member and automated system
* **escalation\_context**: Why escalated (reason, urgency, member sentiment)
* **proposed\_response**: Agent's suggested message with reasoning, tone, and references
* **accessed\_documents**: Tracking of documentation used
...
# Install the agent package and dev dependencies (includes langgraph-cli)
...
* **`metadata`**: Run metadata (run\_id, etc.)
