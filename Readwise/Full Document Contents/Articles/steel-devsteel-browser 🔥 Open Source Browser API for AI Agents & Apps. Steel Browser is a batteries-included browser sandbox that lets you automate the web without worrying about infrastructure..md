...
![rw-book-cover](https://opengraph.githubassets.com/c67ebe15ce9cc30308fdd94b27f1f2805374e48c4383d9327fadb2b8c3c9efa6/steel-dev/steel-browser)

## Metadata
- Author: [[https://github.com/steel-dev/]]
- Full Title: steel-dev/steel-browser: 🔥 Open Source Browser API for AI Agents & Apps. Steel Browser is a batteries-included browser sandbox that lets you automate the web without worrying about infrastructure.
- Category: #articles
- Summary: Steel Browser is an open-source tool that helps AI apps automate web browsing easily. It manages browser tasks like sessions, proxies, and extensions for you. You can run it locally or in the cloud and use it with popular tools like Puppeteer, Playwright, and Selenium.
