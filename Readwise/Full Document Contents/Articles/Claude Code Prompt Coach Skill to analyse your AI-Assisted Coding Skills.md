...
![rw-book-cover](https://substackcdn.com/image/fetch/$s_!MI4y!,w_1200,h_675,c_fill,f_jpg,q_auto:good,fl_progressive:steep,g_auto/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1e812055-75fc-4746-a006-6a849abc4bed_1408x736.png)

## Metadata
- Author: [[Cengiz Han]]
- Full Title: Claude Code Prompt Coach Skill to analyse your AI-Assisted Coding Skills
- Category: #articles
- Summary: Prompt Coach is a skill that analyzes your Claude Code sessions to show how clear and effective your prompts are, where you waste time, and which tools you ignore. It scores your prompts, tracks token use, and gives personalized tips to improve your coding workflow. This helps you work faster, save tokens, and boost productivity by learning from your own usage patterns.
