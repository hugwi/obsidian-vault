...
![rw-book-cover](https://i0.wp.com/alok-mishra.com/wp-content/uploads/2021/07/screen-shot-2021-07-15-at-9.40.10-am.png?fit=1200%2C374&ssl=1)

## Metadata
- Author: [[alokmishra]]
- Full Title: Mapping Business Capabilities to Services
- Category: #articles
- Summary: Map business capabilities to domain services using domain-driven design.  
Define bounded contexts, aggregates, commands, queries, and events to model each domain.  
Organize teams and APIs around those domain services to form a practical API strategy.
- URL: https://alok-mishra.com/2021/07/15/mapping-business-capabilities-to-services/
