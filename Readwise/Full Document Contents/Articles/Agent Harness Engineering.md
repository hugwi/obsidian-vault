...
![rw-book-cover](https://addyosmani.com/assets/images/agent-harness.jpg)

## Metadata
- Author: [[Addy Osmani]]
- Full Title: Agent Harness Engineering
- Category: #articles
- Summary: A coding agent is made of a model plus a harness, which includes all the tools and logic around the model. Harness engineering improves agents by fixing mistakes through better configuration, not just waiting for better models. The harness shapes how the agent works, helping it complete tasks and learn from errors over time.
...
![The anatomy of an agent harness. The model sits in the middle; the harness surrounds it with context injection, control flow, action, persistence, and observation.](https://addyosmani.com/assets/images/harness-anatomy.jpeg)The anatomy of an agent harness. The model sits in the middle; the harness surrounds it with context injection, control flow, action, persistence, and observation.
...
![The model-harness training loop. A useful primitive is discovered in the harness, standardized into the product, used when training the next generation of models, and the next model improves at using that primitive. Cycle repeats.](https://addyosmani.com/assets/images/harness-training-loop.jpeg)The model-harness training loop. A useful primitive is discovered in the harness, standardized into the product, used when training the next generation of models, and the next model improves at using that primitive. Cycle repeats.
