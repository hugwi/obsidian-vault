# skills/greploop/SKILL.md at main · greptileai/skills

![rw-book-cover](https://opengraph.githubassets.com/ade34e4b77c6244e6461793c504a129116a7873f426696f4ff7299dbe233bb62/greptileai/skills)

## Metadata
- Author: [[https://github.com/greptileai/]]
- Full Title: skills/greploop/SKILL.md at main · greptileai/skills
- Category: #articles
- Summary: Greploop is a tool that improves code reviews on GitHub, GitLab, or Perforce until the review score is perfect and no comments remain unresolved. It works by repeatedly pushing changes, triggering Greptile reviews, fixing comments, and resolving threads. The process ends when the confidence score reaches 5/5 or the maximum number of iterations is hit.
- URL: https://github.com/greptileai/skills/blob/main/greploop/SKILL.md

## Full Document
[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/greptileai/skills?resume=1) 
...
Then poll for the Greptile pipeline job to complete (see [GitLab API reference](https://github.com/greptileai/skills/blob/main/greploop/references/gitlab-api.md)):
...
Example (Swarm API): GET /api/v11/comments?topic=reviews/<REVIEW\_ID>
...
GET /api/v11/comments?topic=reviews/<REVIEW\_ID>
...
**GitHub** — fetch unresolved review threads and resolve all that have been addressed (see [GraphQL reference](https://github.com/greptileai/skills/blob/main/greploop/references/graphql-queries.md)):
...
**GitLab** — fetch unresolved discussions and resolve each one (see [GitLab API reference](https://github.com/greptileai/skills/blob/main/greploop/references/gitlab-api.md)):
