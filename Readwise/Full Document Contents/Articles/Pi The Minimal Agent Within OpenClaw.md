...
![rw-book-cover](https://lucumr.pocoo.org/social/2026-01-31-pi-social.png)

## Metadata
- Author: [[Armin Ronacher]]
- Full Title: Pi: The Minimal Agent Within OpenClaw
- Category: #articles
- Summary: Pi is a small and reliable coding agent that writes and runs code using just four tools. It lets users build and extend their own agents by writing code instead of downloading many extensions. This approach powers projects like OpenClaw and shows how software can build more software naturally.
...
![The /answer extension showing a question dialog](https://lucumr.pocoo.org/static/pi-answer.png)The /answer extension showing a question dialog
...
![The /review extension showing review preset options](https://lucumr.pocoo.org/static/pi-review.png)The /review extension showing review preset options
