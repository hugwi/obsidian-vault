...
![rw-book-cover](https://www.thoughtworks.com/content/dam/thoughtworks/images/photography/meta/insights/blog/blg_meta_ddd_implemented_fp.png)

## Metadata
- Author: [[Yang Zhang]]
- Full Title: Domain Driven Design implemented by functional programming
- Category: #articles
- Summary: Domain Driven Design (DDD) pairs domain experts with developers to build clear, high-quality software.  
Functional programming (FP) implements DDD by composing vertical pipelines, keeping domain logic pure and pushing side effects to the edges.  
Use bounded contexts, validation at boundaries, ADTs (union types) and pattern matching to model domain states and enforce correct behavior.
- URL: https://www.thoughtworks.com/en-us/insights/blog/microservices/ddd-implemented-fp
