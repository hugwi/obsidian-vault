...
![rw-book-cover](https://opengraph.githubassets.com/f6c8ec1b03552f0a101166d974db42979cd4483cfc6bf284e1b3cc1c4613076e/disler/pi-vs-claude-code)

## Metadata
- Author: [[https://github.com/disler/]]
- Full Title: disler/pi-vs-claude-code: Comparison between open source PI agent and closed source Claude Code agent
- Category: #articles
- Summary: Comparison between open source PI agent and closed source Claude Code agent - disler/pi-vs-claude-code
- URL: https://github.com/disler/pi-vs-claude-code

## Full Document
[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/disler/pi-vs-claude-code?resume=1) 
...
A collection of [Pi Coding Agent](https://github.com/mariozechner/pi-coding-agent) customized instances. *Why?* To showcase what it looks like to hedge against the leader in the agentic coding market, Claude Code. Here we showcase how you can customize the UI, agent orchestration tools, safety auditing, agent to agent orchestration, and cross-agent integrations.
...
>  🆕 **Pi-to-Pi agent-to-agent communication**. Jump to [Pi-to-Pi Communication](https://github.com/disler/pi-vs-claude-code/#pi-to-pi-agent-to-agent-communication) or watch [Pi to Pi: Two-Way Agent Orchestration](https://youtu.be/PIdETjcXNIk).
> 
>  

[![pi-vs-cc](https://github.com/disler/pi-vs-claude-code/raw/main/images/pi-logo.png)](https://github.com/disler/pi-vs-claude-code/blob/main/images/pi-logo.png)
#### Prerequisites
...
[![Pi to Pi — Two-Way Agent Communication with the Pi Coding Agent](https://github.com/disler/pi-vs-claude-code/raw/main/images/01-hero.png)](https://github.com/disler/pi-vs-claude-code/blob/main/images/01-hero.png)
...
[![The shift: agents as equals, not parent/child — prompt and response both ways](https://github.com/disler/pi-vs-claude-code/raw/main/images/08-the-shift.png)](https://github.com/disler/pi-vs-claude-code/blob/main/images/08-the-shift.png)
...
[![Hierarchy loses — valuable information over titles and politics — ideas die in hierarchies](https://github.com/disler/pi-vs-claude-code/raw/main/images/27-flat-org-info-over-titles.png)](https://github.com/disler/pi-vs-claude-code/blob/main/images/27-flat-org-info-over-titles.png)
...
[![Four tools, zero magic — coms_list discovers peers, coms_send prompts one, coms_get polls, coms_await blocks for the response](https://github.com/disler/pi-vs-claude-code/raw/main/images/14-four-tools.png)](https://github.com/disler/pi-vs-claude-code/blob/main/images/14-four-tools.png)
...
[![coms-net — peer-to-peer across devices — planner @laptop and coder @m4 connected via the hub](https://github.com/disler/pi-vs-claude-code/raw/main/images/21-scale-2.png)](https://github.com/disler/pi-vs-claude-code/blob/main/images/21-scale-2.png)
...
* **Audit log** — every send/receive appends to `coms-log` / `coms-net-log` (msg\_id, sender, hops only — never prompt bodies).
...
For a "soft" variant that lets the agent keep working after a block (turn continues with actionable feedback instead of aborting), use [`damage-control-continue`](https://github.com/disler/pi-vs-claude-code/blob/main/extensions/damage-control-continue.ts).

#### Extension Author Reference

Companion docs cover the conventions used across all extensions in this repo:

* **[COMPARISON.md](https://github.com/disler/pi-vs-claude-code/blob/main/COMPARISON.md)** — Feature-by-feature comparison of Claude Code vs Pi Agent across 12 categories (design philosophy, tools, hooks, SDK, enterprise, and more).
* **[PI\_VS\_OPEN\_CODE.md](https://github.com/disler/pi-vs-claude-code/blob/main/PI_VS_OPEN_CODE.md)** — Architectural comparison of Pi Agent vs OpenCode (open-source Claude Code alternative) focusing on extension capabilities, event lifecycle, and UI customization.
* **[RESERVED\_KEYS.md](https://github.com/disler/pi-vs-claude-code/blob/main/RESERVED_KEYS.md)** — Pi reserved keybindings, overridable keys, and safe keys for extension authors.
* **[THEME.md](https://github.com/disler/pi-vs-claude-code/blob/main/THEME.md)** — Color language: which Pi theme tokens (`success`, `accent`, `warning`, `dim`, `muted`) map to which UI roles, with examples.
* **[TOOLS.md](https://github.com/disler/pi-vs-claude-code/blob/main/TOOLS.md)** — Function signatures for the built-in tools available inside extensions (`read`, `bash`, `edit`, `write`).
...
Released under the [MIT License](https://github.com/disler/pi-vs-claude-code/blob/main/LICENSE) — fork it, ship it, use it however helps you build.
