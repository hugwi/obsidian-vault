...
![rw-book-cover](https://www.datamesh-architecture.com/images/datamesharchitecture_card.png)

## Metadata
- Author: [[datamesh-architecture.com]]
- Full Title: Data Mesh From an Engineering Perspective
- Category: #articles
- Summary: Data mesh shifts data responsibility from a central team to domain teams, letting them create and share data products independently. It uses a decentralized approach supported by a self-serve platform and governance to enable better data collaboration. This organizational change helps teams work with data more effectively and drives innovation across the company.
...
![The central data team in the middle surrounded by all domain teams, CEO, CFO, and marketing who all have an information need the central data team must fulfill, and for that, the central data team needs to import and understand the data of all domain teams.](https://d33wubrfki0l68.cloudfront.net/9191c7180b03679f289d9d33b549c5d39ccbc60c/61cf3/images/whyteam.png.webp)
![You already scaled up your software development by: 1. Decentralize business into domains; 2. Decentralize engineering into autonomous teams; 3. Decentralize monolith into microservices; 4. Decentralize operations into DevOps teams. Next step: scale up data analytics by decentralizing data lake into data mesh](https://d33wubrfki0l68.cloudfront.net/a1bc70b7ea85f05eb40b2e4ec83b96c353e339f6/7ae7a/images/whychecklist.png.webp)
...
[![What Is Data Mesh? Includes the four principles Domain Ownership, Data as a Product, Self-serve Data Platform, and Federated Governance.](https://d33wubrfki0l68.cloudfront.net/92b533c0a0615d987ef6be73d4808e58f13abc51/42026/images/datamesh.png.webp)](https://www.datamesh-architecture.com/images/datamesh.png.webp)
...
![Data Mesh Architecture](https://d33wubrfki0l68.cloudfront.net/9d21c3fae15fc1659479f36a7960343010194297/99387/images/datamesharchitecture.png.webp)
...
![Data Product consists of Data, Metadata, and Operations](https://d33wubrfki0l68.cloudfront.net/09eb792286df1dbba6b62c17099c5581168141e8/e5760/images/dataproduct.png.webp)
...
Global policies such as **privacy** and **compliance** are also common. Think about protection of personally identifiable information (PII) or industry-specific legal requirements.
 ...
 ![Four examples of global polices](https://d33wubrfki0l68.cloudfront.net/64efeeb47b6db29216d0ee2f64e275bcc953eab8/85ee3/images/globalpolicies.png.webp) 
...
[![More detailed view on the analytical data of the data mesh architecture](https://d33wubrfki0l68.cloudfront.net/6cf77e6b0745d43408407c71c0d9f929970140de/b8d29/images/analyticaldata.png.webp)](https://www.datamesh-architecture.com/images/analyticaldata.png.webp)
###### Ingesting
...
*Examples for CDC streaming: [Debezium](https://debezium.io)* 
...
![Closer look at ingesting and cleaning of data](https://d33wubrfki0l68.cloudfront.net/8d0e32cd6a4945e9593fdad69aa2e672d1c6fe09/26140/images/ingestingandcleaning.png.webp)
###### Clean Data
...
| --- | --- |
|  | -- Step 1: Deduplicate |
|  | WITH inventory\_deduplicated AS ( |
|  |  SELECT \* |
|  |  EXCEPT (row\_number) |
|  |  FROM ( |
|  |  SELECT \*, |
|  |  ROW\_NUMBER() OVER (PARTITION BY id ORDER BY time DESC) row\_number |
|  |  FROM `datameshexample-fulfillment.raw.inventory`) |
|  |  WHERE row\_number = 1 |
|  | ), |
|  | -- Step 2: Parse JSON to columns |
|  | inventory\_parsed AS ( |
|  |  SELECT |
|  |  json\_value(data, "$.sku") AS sku, |
|  |  json\_value(data, "$.location") AS location, |
|  |  CAST(json\_value(data, "$.available") AS int64) AS available, |
|  |  CAST(json\_value(data, "$.updated\_at") AS timestamp) AS updated\_at, |
|  |  FROM inventory\_deduplicated |
|  | ) |
|  | -- Step 3: Actual Query |
|  | SELECT sku, location, available, updated\_at |
|  | FROM inventory\_parsed |
|  | ORDER BY sku, location, updated\_at |
...
![Jupyter Notebook executing queries on Google BigQuery](https://d33wubrfki0l68.cloudfront.net/57306d37b7e8994a42e9c495824318121868a461/2c628/images/notebook.png.webp)
###### Data Platform
...
[![Domains access data products from other domains](https://d33wubrfki0l68.cloudfront.net/9ef133ee7b90a536d1b0fa366cf7432869c53842/d9dca/images/mesh.png.webp)](https://www.datamesh-architecture.com/images/mesh.png.webp)
...
[![Level 0: No Data Analytics](https://d33wubrfki0l68.cloudfront.net/61f733811ce505bfde41a7d98d257dfec48ac19f/931c6/images/domainteamjourney_level0.png.webp)](https://www.datamesh-architecture.com/images/domainteamjourney_level0.png.webp)
...
[![Level 1: Operational Database Queries](https://d33wubrfki0l68.cloudfront.net/af251b36e85c20d8a5a3b519043199a1938f2cd0/540ac/images/domainteamjourney_level1.png.webp)](https://www.datamesh-architecture.com/images/domainteamjourney_level1.png.webp)
...
[![Level 2: Analyze Own Data](https://d33wubrfki0l68.cloudfront.net/282f02e0f3be952011bb65849aac1c02b3a7d680/b9a7b/images/domainteamjourney_level2.png.webp)](https://www.datamesh-architecture.com/images/domainteamjourney_level2.png.webp)
...
[![Level 3: Analyze Cross-domain Data](https://d33wubrfki0l68.cloudfront.net/fece9ab8c792dce5c1ce98b4fb114ec0e4c3d6f8/71ef9/images/domainteamjourney_level3.png.webp)](https://www.datamesh-architecture.com/images/domainteamjourney_level3.png.webp)
...
[![Level 4: Publish Data as a Product](https://d33wubrfki0l68.cloudfront.net/e2a2ae0acdca4b8d82c95d19e23447b3f02c2f20/d2d65/images/domainteamjourney_level4.png.webp)](https://www.datamesh-architecture.com/images/domainteamjourney_level4.png.webp)
[![Data Team's Journey: From a central data team toward an enablement team, data platform team, and (new) domain teams with data expertise](https://d33wubrfki0l68.cloudfront.net/cf33dea63f5ec2dc6e12f2e304d4f31ed7930c1e/f5704/images/datateamjourney.png.webp)](https://www.datamesh-architecture.com/images/datateamjourney.png.webp)
...
[![Migrating an existing data product and some data engineers from the central data team to a (new) domain team](https://d33wubrfki0l68.cloudfront.net/8f1d10b6c66454d92a01093bdcfbe6b92314b5e6/8ea2b/images/newdomainteam.png.webp)](https://www.datamesh-architecture.com/images/newdomainteam.png.webp)
#### FAQ
