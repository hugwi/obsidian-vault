...
![rw-book-cover](https://opengraph.githubassets.com/218a0cb277ee3614a4e4606780f16bfd17c116e2ad465d622ff80f136c90a0ec/firstloophq/claude-code-test-runner)

## Metadata
- Author: [[https://github.com/firstloophq/]]
- Full Title: firstloophq/claude-code-test-runner: An automated E2E natural language test runner built on Claude Code
- Category: #articles
- Summary: Claude Code Test Runner automates end-to-end web tests using simple natural language steps. It adapts to changes and handles issues like a human tester, making tests more reliable. The tool runs tests through a CLI, supports Docker, and provides detailed results and logs.
- URL: https://github.com/firstloophq/claude-code-test-runner/tree/main

## Full Document
[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/firstloophq/claude-code-test-runner?resume=1) 
...
Tests are defined in JSON using sequential, natural language steps. The expected schema is a JSON array of [TestCase](https://github.com/firstloophq/claude-code-test-runner/blob/main/cli/src/types/test-case.ts) objects. See [samples/thisinto-e2e-tests.json](https://github.com/firstloophq/claude-code-test-runner/blob/main/samples/thisinto-e2e-tests.json) for a concrete example.
...
The CLI described above is also bundled into a Docker container, available on GHCR. This container can be used directly in GitHub actions, as demonstrated [here](https://github.com/firstloophq/claude-code-test-runner/blob/main/.github/workflows/sample-tests-action.yml)
...
Some content could not be imported from the original document. [View content ↗](https://viewscreen.githubusercontent.com/markdown/mermaid?docs_host=https%3A%2F%2Fdocs.github.com&color_mode=light#e7fca4f5-6d15-4a58-9fbc-0dcd5188ba53) 
...
The Test State MCP server is particularly important as it provides a feedback loop between the test runner and Claude Code. It exposes two main tools:
...
This architecture ensures Claude Code always knows what test it's executing and can report results back to the runner, enabling proper test orchestration and reporting.
