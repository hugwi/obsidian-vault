...
![rw-book-cover](https://paddo.dev/og/blog/flux-kanban-for-ai-agents.png)

## Metadata
- Author: [[paddo.dev]]
- Full Title: Flux: A Kanban Board That Speaks MCP
- Category: #articles
- Summary: Flux is a simple Kanban board made for AI coding agents to manage tasks clearly and efficiently. It works offline, syncs with git, and lets agents pick tasks by priority without complex setups. Flux is open-source and helps teams and AI work together smoothly.
- URL: https://paddo.dev/blog/flux-kanban-for-ai-agents
