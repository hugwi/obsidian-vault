...
- Full Title: Don't "Trust the Process"
- Category: #articles
- Summary: Jenny Wen says the traditional Design Process is outdated because anyone can create anything today. She suggests designers focus on making prototypes quickly, using AI to save time. This approach helps find better ideas faster and reduces costly mistakes.
- URL: https://simonwillison.net/2026/Jan/24/dont-trust-the-process/

## Full Document
**[Don't "Trust the Process"](https://www.youtube.com/watch?v=4u94juYwLLM)** ([via](https://twitter.com/jenny_wen/status/2014479445738893649)) Jenny Wen, Design Lead at Anthropic (and previously Director of Design at Figma) gave a provocative keynote at Hatch Conference in Berlin last September.
