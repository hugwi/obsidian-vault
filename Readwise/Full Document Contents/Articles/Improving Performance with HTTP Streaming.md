...
![rw-book-cover](https://miro.medium.com/v2/resize:fit:1200/1*q2A2ZjnULygCKIWuiSBKXg.jpeg)

## Metadata
- Author: [[Victor]]
- Full Title: Improving Performance with HTTP Streaming
- Category: #articles
- Summary: Airbnb improved web performance by using HTTP Streaming, which sends parts of a webpage in chunks to load faster. They broke their page into early head, late head, and body components to stream content and data efficiently. This method reduced loading times and made their site feel quicker for users.
