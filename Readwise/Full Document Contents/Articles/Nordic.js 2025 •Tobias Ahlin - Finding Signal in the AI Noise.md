# Nordic.js 2025 •Tobias Ahlin - Finding Signal in the AI Noise

![rw-book-cover](https://i.ytimg.com/vi/3qwJFEsj4TY/sddefault.jpg)

## Metadata
- Author: [[Nordic.js]]
- Full Title: Nordic.js 2025 •Tobias Ahlin - Finding Signal in the AI Noise
- Category: #articles
- Summary: AI is getting smarter but still makes many mistakes and has limits. The key challenge is managing many AI agents that are smart but lack clear direction. Success will come from designing systems where AI agents work together by debating and disagreeing to find the best solutions.
- URL: https://www.youtube.com/watch?v=3qwJFEsj4TY
