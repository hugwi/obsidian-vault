...
![rw-book-cover](https://opengraph.githubassets.com/a31f0c7273349d184048b045991dd8540a04ba8045e5bfc008f1c267f26be3c2/confident-ai/deepeval)

## Metadata
- Author: [[https://github.com/confident-ai/]]
- Full Title: confident-ai/deepeval: The LLM Evaluation Framework
- Category: #articles
- Summary: DeepEval is an open-source tool for evaluating large language models using many ready-made and custom metrics. It works with popular AI frameworks like OpenAI, LangChain, and Anthropic to test tasks such as accuracy, relevancy, and hallucination. Users can run detailed evaluations and share reports to improve their AI applications easily.
