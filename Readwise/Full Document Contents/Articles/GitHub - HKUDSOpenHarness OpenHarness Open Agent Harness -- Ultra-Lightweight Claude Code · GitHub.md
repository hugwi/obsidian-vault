...
![rw-book-cover](https://opengraph.githubassets.com/436d548e41a66ea049c7aca81e65eb7e3770ea32c06b3ac616da7e85220275f2/HKUDS/OpenHarness)

## Metadata
- Author: [[https://github.com/HKUDS/]]
- Full Title: GitHub - HKUDS/OpenHarness: "OpenHarness: Open Agent Harness -- Ultra-Lightweight Claude Code" · GitHub
- Category: #articles
- Summary: OpenHarness is a very lightweight, open-source Python tool that makes AI models work like helpful agents. It uses only a small part of the code compared to Claude Code but still offers most key features and tools. Users can customize it with new tools, skills, and plugins to build smart AI assistants easily.
