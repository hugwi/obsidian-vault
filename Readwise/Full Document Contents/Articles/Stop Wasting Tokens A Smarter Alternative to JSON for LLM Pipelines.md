...
![rw-book-cover](https://www.kdnuggets.com/wp-content/uploads/kdn-stop-wasting-tokens-a-smarter-alternative-to-json-for-llm-pipelines-2.png)

## Metadata
- Author: [[Kanwal Mehreen]]
- Full Title: Stop Wasting Tokens: A Smarter Alternative to JSON for LLM Pipelines
- Category: #articles
- Summary: TOON is a new format that reduces repeated JSON tokens in large language model prompts, making input more efficient. It keeps the same data as JSON but uses fewer tokens by listing field names once and then streaming values. TOON works best for repeated, uniform data and should be tested alongside JSON to see what fits each LLM task.
- URL: https://www.kdnuggets.com/stop-wasting-tokens-a-smarter-alternative-to-json-for-llm-pipelines
