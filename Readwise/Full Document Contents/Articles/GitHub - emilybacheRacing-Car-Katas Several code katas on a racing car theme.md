...
![rw-book-cover](https://repository-images.githubusercontent.com/10648365/bd2bdc79-c4ea-4597-8459-6c50002feb1e)

## Metadata
- Author: [[https://github.com/emilybache/]]
- Full Title: GitHub - emilybache/Racing-Car-Katas: Several code katas on a racing car theme
- Category: #articles
- Summary: This GitHub repository offers coding exercises with a racing car theme to help improve skills in unit testing and SOLID design principles. Each exercise involves writing tests for legacy code and then refactoring it to be more testable without changing its behavior. The author provides videos, blog posts, and example solutions to support learning.
