...
![rw-book-cover](https://deloughry.co.uk/og-image/claude-code--skills-plugins.png)

## Metadata
- Author: [[Matthew Peck-Deloughry]]
- Full Title: Claude Code: Skills, Plugins, and the JSONC Design Spec Trick That Changed My Workflow
- Category: #articles
- Summary: Claude Code uses Skills, Plugins, and a JSONC design spec to improve AI-assisted coding and design. This method helps create unique frontends quickly and precisely. Claude also gives feedback to improve prompts and workflow.
- URL: https://deloughry.co.uk/posts/claude-code--skills-plugins
