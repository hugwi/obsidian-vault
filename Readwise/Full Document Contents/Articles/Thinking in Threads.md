...
![rw-book-cover](https://agenticengineer.com/thinking-in-threads/hero.webp)

## Metadata
- Author: [[@IndyDevDan]]
- Full Title: Thinking in Threads
- Category: #articles
- Summary: Thread-Based Engineering is a new way to work with AI agents by running multiple connected tasks called threads. It helps engineers scale their work by managing many agents in parallel or in stages, increasing output and reliability. By thinking in threads, you improve your skills and let agents do more work autonomously over time.
- URL: https://agenticengineer.com/thinking-in-threads

## Full Document
![@IndyDevDan](https://agenticengineer.com/indy-dev-dan.png)
![Thinking in Threads - Thread-Based Engineering with Claude Code](https://agenticengineer.com/thinking-in-threads/hero.webp)Thinking in Threads - Thread-Based Engineering with Claude Code
...
![Thread-Based Engineering Overview](https://agenticengineer.com/thinking-in-threads/1-overview-poster.webp)Thread-Based Engineering Overview
...
![Base Thread Diagram](https://agenticengineer.com/thinking-in-threads/2-base-poster.webp)Base Thread Diagram
...
![P-Thread Parallel Diagram](https://agenticengineer.com/thinking-in-threads/3-p-thread-poster.webp)P-Thread Parallel Diagram
...
![C-Thread Checkpoint Diagram](https://agenticengineer.com/thinking-in-threads/4-c-thread-poster.webp)C-Thread Checkpoint Diagram
...
![F-Thread Fusion Diagram](https://agenticengineer.com/thinking-in-threads/6-f-thread-poster.webp)F-Thread Fusion Diagram
...
![B-Thread Branch Diagram](https://agenticengineer.com/thinking-in-threads/5-b-thread-poster.webp)B-Thread Branch Diagram
...
![L-Thread Long Running Diagram](https://agenticengineer.com/thinking-in-threads/7-l-thread-poster.webp)L-Thread Long Running Diagram
...
![Four Ways to Improve Threads](https://agenticengineer.com/thinking-in-threads/9-improve-poster.webp)Four Ways to Improve Threads
...
![Z-Thread Zero-Touch Diagram](https://agenticengineer.com/thinking-in-threads/11-z-thread-poster.webp)Z-Thread Zero-Touch Diagram
