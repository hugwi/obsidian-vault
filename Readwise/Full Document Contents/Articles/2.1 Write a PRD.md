...
![rw-book-cover](https://ccforpms.com/images/better-graphic.png)

## Metadata
- Author: [[Learn Claude Code IN Claude Code!]]
- Full Title: 2.1: Write a PRD
- Category: #articles
- Document Tags: [[prd]] [[aidd]] [[spec]] 
- Summary: This module teaches how to write better PRDs by partnering with AI to add context, ask smart questions, and get diverse feedback. You create multiple strategies and refine your draft before sharing it with your team. The key is using AI to improve your thinking, not to do the work for you.
...
| Category | Questions |
| --- | --- |
| **Problem Clarity** | What specific user pain point does this solve?Who experiences this most acutely?What’s the cost of NOT solving this? |
| **Solution Validation** | Why is this the right solution?What alternatives did you consider?What’s the simplest version? |
| **Success Criteria** | How will we measure success?What would indicate failure?What metric are we moving and by how much? |
| **Constraints** | What technical risks exist?What are we NOT doing?If we had half the time, what would we cut? |
| **Strategic Fit** | Why build this RIGHT NOW?How does this fit our broader strategy?How does this affect competitive position? |
