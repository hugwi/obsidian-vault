...
![rw-book-cover](https://rpiv-pi.com/og-square.png)

## Metadata
- Author: [[rpiv-pi]]
- Full Title: pi-ai · pi-coding-agent · pi-tui
- Category: #articles
- Summary: Pi-ai is a coding agent that breaks down tasks into research, design, planning, implementation, and validation steps. It uses a system of skills and artifacts to move from vague goals to shipped code. The agent also manages context with per-folder guidance files to work effectively in large codebases.
