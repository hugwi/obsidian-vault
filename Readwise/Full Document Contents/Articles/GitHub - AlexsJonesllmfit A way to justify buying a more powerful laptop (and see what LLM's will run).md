...
![rw-book-cover](https://opengraph.githubassets.com/d560612fd93d4792a4f2f672875fb7f101ee9b8c5b3e463f821ca5dfcdbd6ef4/AlexsJones/llmfit)

## Metadata
- Author: [[https://github.com/AlexsJones/]]
- Full Title: GitHub - AlexsJones/llmfit: A way to justify buying a more powerful laptop (and see what LLM's will run)
- Category: #articles
- Summary: llmfit is a tool that checks if large language models will run well on your computer by comparing them to your system's RAM, CPU, and GPU. It supports a terminal user interface and classic command-line mode, showing which of 33 popular models fit your hardware. You can install it easily and even add new models by updating its database.
...
[![demo](https://github.com/AlexsJones/llmfit/raw/main/demo.gif)](https://github.com/AlexsJones/llmfit/blob/main/demo.gif)
  [![demo](https://github.com/AlexsJones/llmfit/raw/main/demo.gif)](https://github.com/AlexsJones/llmfit/blob/main/demo.gif)  

Example of a medium performance home laptop

[![home](https://github.com/AlexsJones/llmfit/raw/main/home_laptop.png)](https://github.com/AlexsJones/llmfit/blob/main/home_laptop.png)
#### Install
...
2. **Model database** -- 33 models sourced from the HuggingFace API, stored in `data/hf_models.json` and embedded at compile time. Memory requirements are computed from parameter counts using Q4\_K\_M quantization (0.5 bytes/param). VRAM is the primary constraint for GPU inference; system RAM is the fallback for CPU-only execution.
 ...
 **Run modes:**
	...
	* **CPU** -- No GPU detected. Model loaded entirely into system RAM. Slow.**Fit levels:**
