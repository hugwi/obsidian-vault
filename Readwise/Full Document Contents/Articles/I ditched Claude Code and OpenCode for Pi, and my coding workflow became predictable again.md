...
![rw-book-cover](https://static0.xdaimages.com/wordpress/wp-content/uploads/wm/2026/03/pi-terminal.jpg?w=1600&h=900&fit=crop)

## Metadata
- Author: [[Joe Rice-Jones]]
- Full Title: I ditched Claude Code and OpenCode for Pi, and my coding workflow became predictable again
- Category: #articles
- Summary: The author switched to Pi, an AI coding harness, because it gives more control and uses fewer tokens than others like Claude Code and OpenCode. Pi lets users see and manage everything the AI does, making coding more predictable and efficient. It also can create its own extensions, helping customize workflows easily.
- URL: https://www.xda-developers.com/replaced-claude-code-and-opencode-with-pi/
