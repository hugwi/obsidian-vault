...
![rw-book-cover](https://cdn.thenewstack.io/media/2026/05/fcc75a59-studio-hd-vrjkrkdmnq-unsplash-scaled.jpg)

## Metadata
- Author: [[Arjun Iyer & Frederic Lardinois & Paul Sawers & Matthew Burns & Charlotte Fleming & Boris Chabeda & Ed Huang & Eric Newcomer & Nick Lucchesi & Carly Page]]
- Full Title: Why agent harnesses fail inside cloud-native systems
- Category: #articles
- Summary: Coding agents need feedback loops to know if their changes work, but cloud-native systems make this feedback hard to provide. Current methods like mocks or late CI tests break the feedback loop, causing delays and human intervention. A better solution is fast, realistic, programmable environments that give agents real-time feedback inside their workflow.
- URL: https://thenewstack.io/agent-harness-distributed-feedback-problem/
