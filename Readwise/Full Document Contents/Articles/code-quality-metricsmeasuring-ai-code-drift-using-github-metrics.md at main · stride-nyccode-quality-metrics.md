...
![rw-book-cover](https://opengraph.githubassets.com/30f1a2d19f38c74614f7883e2b8d12a0f9a37676d123b7524d5f1eb2db1476bd/stride-nyc/code-quality-metrics)

## Metadata
- Author: [[https://github.com/stride-nyc/]]
- Full Title: code-quality-metrics/measuring-ai-code-drift-using-github-metrics.md at main · stride-nyc/code-quality-metrics
- Category: #articles
- Summary: AI coding tools help developers write code faster but often cause bigger, harder-to-review changes that increase bugs and reduce team delivery quality. Research shows teams with strong development practices benefit from AI, while weaker teams create more technical debt faster. Measuring AI code drift early, especially before merging, helps detect risks and improve software quality.
- URL: https://github.com/stride-nyc/code-quality-metrics/blob/main/measuring-ai-code-drift-using-github-metrics.md

## Full Document
[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/stride-nyc/code-quality-metrics/tree/main?resume=1) 
...
A detailed breakdown of measurable signals, gaps, and the tools that address each gap is available in the companion [Metrics Specification](https://github.com/stride-nyc/code-quality-metrics/blob/main/metrics-specification.md).
