# Rethinking Domain Layer Folder Structure for Clean Architecture

![rw-book-cover](https://media.licdn.com/dms/image/v2/D4D22AQFlRQj7SGf8bw/feedshare-shrink_800/B4DZtZkX0bKAAg-/0/1766734268001?e=2147483647&v=beta&t=UcFQZWFwCUFV0sQTWpHHdmMISEiYAu_-LKvaKSdgrAM)

## Metadata
- Author: [[Milan Jovanović]]
- Full Title: Rethinking Domain Layer Folder Structure for Clean Architecture
- Category: #articles
- Summary: The Domain layer should be organized by related features, not by technical types like entities or repositories. This makes the code more cohesive and easier to understand. Grouping by features leads to better structure and supports Vertical Slice Architecture.
- URL: https://www.linkedin.com/posts/milan-jovanovic_the-domain-layer-folder-structure-should-activity-7410220758771167232-l14B?utm_source=share&utm_medium=member_android&rcm=ACoAACDYSKgBNrQFbnZBbm-5p711lB6NBjpcBXA
