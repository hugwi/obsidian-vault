...
![rw-book-cover](https://opengraph.githubassets.com/75d28eb7b90e4cfc4b39d680669bf9252ff651976fab48e0c453868190c5cf09/tirth8205/code-review-graph)

## Metadata
- Author: [[https://github.com/tirth8205/]]
- Full Title: tirth8205/code-review-graph: Local knowledge graph for Claude Code. Builds a persistent map of your codebase so Claude reads only what matters — 6.8× fewer tokens on reviews and up to 49× on daily coding tasks.
- Category: #articles
- Summary: code-review-graph builds a detailed map of your code to help AI tools review only the important parts, saving many tokens. It updates quickly with every change and supports 19 programming languages plus notebooks. This tool improves efficiency, especially in large projects, by focusing on affected files and ignoring irrelevant code.
