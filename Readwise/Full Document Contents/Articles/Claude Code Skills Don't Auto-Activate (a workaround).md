...
![rw-book-cover](https://og.scott.garden/og?title=Claude%20Code%20Skills%20Don't%20Auto-Activate%20(a%20workaround)&author=Scott%20Spence&website=scottspence.com)

## Metadata
- Author: [[Scott Spence]]
- Full Title: Claude Code Skills Don't Auto-Activate (a workaround)
- Category: #articles
- Summary: Claude Code skills do not activate automatically despite being listed and having trigger words. To make them work reliably, you must use hooks that explicitly tell Claude to use a skill when certain keywords appear. However, this method is imperfect and often inconsistent, so directly invoking skills in prompts is more dependable.
