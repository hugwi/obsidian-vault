# How I Built an AI Documentation Engine with Tree-sitter, Claude AI, and RAG

![rw-book-cover](https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fautomadocs.com%2Fog-image.png)

## Metadata
- Author: [[Elizabeth Stein]]
- Full Title: How I Built an AI Documentation Engine with Tree-sitter, Claude AI, and RAG
- Category: #articles
- Summary: Elizabeth Stein built AutomaDocs, an AI tool that keeps code documentation updated automatically by analyzing code structure with Tree-sitter and generating text using Claude AI. The system syncs changes instantly using GitHub webhooks and improves search with a hybrid retrieval method. This approach makes documentation easier to maintain and more accurate without manual work.
- URL: https://dev.to/liztacular/how-i-built-an-ai-documentation-engine-with-tree-sitter-claude-ai-and-rag-4jgk
