...
![rw-book-cover](https://opengraph.githubassets.com/e372a967d6f786ff032f50a7d0fb8bd0a87887fa5318d2b8c1c1a7028e0ecb65/eminetto/clean-architecture-go-v2/issues/3)

## Metadata
- Author: [[https://github.com/eminetto/]]
- Full Title: Clean architecture folder structure · Issue #3 · eminetto/clean-architecture-go-v2
- Category: #articles
- Summary: Clean architecture in Go uses self-contained domains with clear separation, but importing similarly named packages requires careful aliasing. Direct cross-domain references should be avoided to keep boundaries clear, even if it means more boilerplate. Go favors simple naming conventions and minimal abstraction, differing from traditional OOP practices.
- URL: https://github.com/eminetto/clean-architecture-go-v2/issues/3
