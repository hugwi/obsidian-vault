# agent-skills/skills/read-only-postgres at main · jawwadfirdousi/agent-skills · GitHub

![rw-book-cover](https://opengraph.githubassets.com/1b100bd5a26a0a539e08e6a11a86434dfb4ff9fc3a384eaf6556953e78a9eef1/jawwadfirdousi/agent-skills)

## Metadata
- Author: [[https://github.com/jawwadfirdousi/]]
- Full Title: agent-skills/skills/read-only-postgres at main · jawwadfirdousi/agent-skills · GitHub
- Category: #articles
- Summary: This project provides a safe read-only PostgreSQL query tool for multiple databases with built-in write protection and PII data masking. Users configure database connections, customize queries, and ensure security with features like query validation and timeouts. The tool helps prevent data leaks and accidental changes while allowing easy access to database information.
- URL: https://github.com/jawwadfirdousi/agent-skills/tree/main/skills/read-only-postgres
...
#### [README.md](https://github.com/jawwadfirdousi/agent-skills/tree/main/skills/read-only-postgres/#readme)
...
| pii\_masking | No | - | Map of table names to column arrays to mask (see below) |
...
| Original | Masked |
| --- | --- |
| [john@email.com](mailto:john@email.com) | j\*\*\*\*\*\*\*\*\*\*\*\*m |
| 555-1234 | 5\*\*\*\*\*\*4 |
| Jo | Jo |
