...
![rw-book-cover](https://www.aidesigner.ai/opengraph.png)

## Metadata
- Author: [[aidesigner.ai]]
- Full Title: AIDesigner
- Category: #articles
- Summary: AIDesigner helps you create AI-generated UI designs quickly inside your project using simple commands. It connects with various AI clients and uses your code context to make designs that fit your stack. You can generate, refine, and preview designs, and get guides to adopt them into your code.
- URL: https://www.aidesigner.ai/docs/mcp
