...
![rw-book-cover](https://opengraph.githubassets.com/c888b78cfa456fd19d927cdb7afe4a3632a26d51c620a1c552bbecf730b21156/shep-ai/cli)

## Metadata
- Author: [[https://github.com/shep-ai/]]
- Full Title: GitHub - shep-ai/cli: Multi-Session SDLC Control Center for AI Coding Agents · GitHub
- Category: #articles
- Summary: Shep AI is a command-line tool that automates the full software development lifecycle for coding features using AI agents. It manages research, planning, coding, testing, and pull requests with optional human approval at key stages. The tool runs locally with a web dashboard and supports multiple agents, repositories, and parallel workflows without needing cloud services.
- URL: https://github.com/shep-ai/cli
