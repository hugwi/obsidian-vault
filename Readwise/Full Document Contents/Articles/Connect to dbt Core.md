...
![rw-book-cover](https://www.databricks.com/wp-content/uploads/2020/04/og-databricks.png)

## Metadata
- Author: [[databricks.com]]
- Full Title: Connect to dbt Core
- Category: #articles
- Summary: dbt Core is a free, open-source tool that helps you transform data by running SQL code on Databricks from your local machine. To use it, you create a Python virtual environment, install the dbt Databricks adapter, and configure connection settings to your Databricks cluster or SQL warehouse. You then test the connection to ensure everything is set up correctly before running your dbt projects.
- URL: https://docs.databricks.com/en/partners/prep/dbt.html
