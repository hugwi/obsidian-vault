...
Now with Claude Code and MCP tools for JIRA or Linear, everything changed. I can sit in bed and run a custom bedtime agent instead of scrolling Reddit or Instagram. I’ve set up my `~/.claude/agents/bedtime.md` file to help find simple tasks. These are things I can start tonight and finish tomorrow.
