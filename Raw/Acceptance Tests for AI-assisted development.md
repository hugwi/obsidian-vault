...
created: 2026-08-31
description: "In my experiments with AI-assisted software development, and especially when trying spec-driven development, I found that Acceptance Tests are key to enable success.  Here’s my take on them.Update 2026-03-06: the Approved Fixtures pattern from the Augmented Coding Patterns website tells a very similar story in much fewer words, with convincing examples.The scoop on Acceptance TestsOne of the original practices of Extreme Programming was “Customer Tests”, more commonly known as “Acceptance Tests”: these are tests that are written from the point of view of the business, and they prove that a given business rule has been implemented by checking specific examples of that business rule; e.g., when the user does X, in context Y, then Z should happen."
tags:
  - "raw"
---
...
![The ATDD process](https://matteo.vaccari.name/posts/acceptance-tests-for-ai-assisted-development/tdd-with-acceptance-tests.svg)

TDD with acceptance tests. From Freeman's and Pryce's book, reproduced here with a Creative Commons Attribution-ShareAlike 4.0 license
...
![Ports-and-adapters architecture](https://matteo.vaccari.name/posts/acceptance-tests-for-ai-assisted-development/ports-and-adapters-architecture.svg)

The Ports-and-adapters architecture. From Freeman's and Pryce's book, reproduced here with a Creative Commons Attribution-ShareAlike 4.0 license
...
[#AI](https://matteo.vaccari.name/posts/ai/) [#XP](https://matteo.vaccari.name/posts/xp/) [#TDD](https://matteo.vaccari.name/posts/tdd/) [#ATDD](https://matteo.vaccari.name/posts/atdd/) [#Ports-and-Adapters](https://matteo.vaccari.name/posts/ports-and-adapters/)