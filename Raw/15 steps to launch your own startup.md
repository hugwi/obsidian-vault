...
- Full Title: 15 steps to launch your own startup
- Category: #articles
- Summary: Starting a tech startup is very hard and needs many skills, experience, and a strong team. Find good co-founders, mentors, and a supportive community to help you grow. Focus on long-term goals, learn from failures, and be ready to take risks and adapt quickly.
- URL: https://freedium-mirror.cfd/https://medium.com/@christianreber/15-steps-to-launch-your-own-startup-74e945869ca4

## Full Document
![Preview image](https://miro.medium.com/v2/resize:fit:700/1*1C14x8ytMfOCq4vUgwioYA.jpeg)Preview image
#### How to build a tech business from scratch

I was only 19 when I moved to Berlin to study Computer Science and International Management. My big dream was to start a global tech company that would have a lasting impact in Europe. Now, [Wunderlist](http://wunderlist.com) is almost three years old and looking back, things have turned out so much more differently than what I had expected. So far it has been the best time of my life –What a ride!
...
The US has [excellent universities for entrepreneurs](http://www.forbes.com/sites/michaelnoer/2012/08/01/the-most-entrepreneurial-colleges/), most famously Harvard (Mark Zuckerberg, Bill Gates) and Stanford (Elon Musk, Larry Page).

![None](https://miro.medium.com/v2/resize:fit:700/0*jfPGfI_7F75XuyEH.jpg)Stanford University in California
Germany is also a hub for the [best universities for entrepreneurs](http://www.gruenderszene.de/allgemein/top-startup-unis) — here are my personal favorites specializing in the tech industry:
...
When I was 16 or so, I discovered a book called [Rich Dad, Poor Dad — What the Rich Teach Their Kids About Money](http://www.amazon.com/Rich-Dad-Poor-Teens-Money-that/dp/0762436549/ref=pd_sim_b_1). I might have even read the childrens edition — but I loved it! I've recommended it to many of my friends because it contains a solid piece of advice: **"Work to learn, not to earn."**
...
If you're looking for a startup job in Berlin, join the Facebook group [Berlin Startup Jobs](https://www.facebook.com/groups/BerlinStartupJobs/) or visit [http://berlinstartupjobs.com](http://berlinstartupjobs.com/).

##### 3. Join the community and meet founders

Spending time with ambitious and like minded people shaped my own path. Most of my friends are developers, designers, entrepreneurs, and work for different kinds of startups. When you move to a new city, like I did, it can take some time to connect with other founders. Leo Widrich, one of the co-founders of Buffer, wrote a great, provocative piece about [the importance of the people you spend time with](http://leostartsup.com/2012/07/the-people-you-spend-time-with), and quoted the entrepreneur Jim Rohn:
...
To help aspiring entrepreneurs facing the same issues, I started a Facebook group called [Berlin Startups](https://www.facebook.com/groups/159595270791268). My goal was simple, I wanted to build a community to connect people and allow them to share knowledge. I invited founders, investors, lawyers, developers, designers and many more. The group now has more than 17,000 members (updated Nov 2014), with people representing almost every German startup. It's now the easiest way to discover startup events and connect with great people.

Besides connecting with founders, I would also recommend you identify potential mentors. These can be entrepreneurs who you think are doing a phenomenal job in building great companies. Surround yourself with them, learn from them. You'll find out it's easier than you think to get in touch with these people. It's incredible how much you can learn from a single 30 minute meeting. I spent a lot of time in the beginning just reading about entrepreneurs and watching interviews on YouTube. I recommend you watch interviews on [PandoMonthly](http://www.youtube.com/results?search_query=PandoMonthly), [Foundation](http://foundation.bz/),[Stanford's Entrepreneurship Corner](http://ecorner.stanford.edu/popularVideos.html) and [This Week in Startups](http://thisweekinstartups.com/).

I follow many founders, CEOs, industry leaders, venture capitalists and other startups on [Twitter](https://twitter.com/christianreber/following) and Facebook to learn more about who they are, and what they do. It's a quick way to learn more about trends and important topics.

Read blogs like [TNW](http://thenextweb.com/), [TechCrunch](http://techcrunch.com/), and [The Verge](http://www.theverge.com/) to keep up-to-date. I also love to read the blogs of founders and investors, especially [Fred Wilson](http://www.avc.com/), [Brad Feld](http://www.feld.com/), [Ben Horowitz](http://bhorowitz.com/), [Tom Tunguz](http://tomtunguz.com/) and many more.
...
The main hub for starting a tech business is currently San Francisco. It's an amazing city, full of people working at tech businesses, and ready to start the next big thing. But, the challenges you will face there as a first-time entrepreneur are huge. The costs of living are incredibly high and you will compete with the world's most successful tech businesses for talent. Then if you're successful in finding them, you will spend more money for recruiting talented people than in any other city in the world. Jason Evanish wrote a great post about [25 Things I wish I knew before moving to San Francisco](http://jasonevanish.com/2013/01/17/25-things-i-wish-i-knew-before-moving-to-san-francisco/).
...
If you need an office to work, look out for co-working spaces, there are quite a few in Berlin: [Betahaus](http://betahaus.de/), [Ahoy!](http://www.ahoyberlin.com/), [co-up](http://co-up.de/), [mobilesuite](http://www2.mobilesuite.de/coworking/standort/berlin-prenzlauer-berg), [Raumstation](http://www.raumstation-berlin.net/).
...
Kevin Systrom gave an [inspiring talk about Instagram](http://ecorner.stanford.edu/authorMaterialInfo.html?mid=2735) and he explained the reasons why it became such a success. I think you can nail it down to these 3 precise problems Instagram fixed:
...
I regularly watch documentaries about different trainers, to understand how they motivate their teams. It's unrelated to the startup world, but I can highly recommend to watch "[Being Liverpool](http://www.youtube.com/watch?v=fM0dzuk1Tek)". When you watch it, replace Liverpool with your own business, and you will understand what I mean.

Some content could not be imported from the original document. [View content ↗](https://cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fwww.youtube.com%2Fembed%2FfM0dzuk1Tek%3Ffeature%3Doembed&url=http%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DfM0dzuk1Tek&image=http%3A%2F%2Fi.ytimg.com%2Fvi%2FfM0dzuk1Tek%2Fhqdefault.jpg&key=d04bfffea46d4aeda930ec88cc64b87c&type=text%2Fhtml&schema=youtube) 

At [Wunderlist](http://wunderlist.com), our motivation is a combination of passion for what we're doing (creating the best productivity software in the world) as well as our strong and endless will to build up an impressive team and business. My mission as an entrepreneur always was (and still is) to build a world-dominating design-driven software company. A company that goes beyond a one-hit-wonder, and is able to iterate and improve from success to success. That's what drives me and motivates me.
...
***A product person*** This person should be obsessed with the product details and strategy. They should be able to hire great designers to help build a better product. They should constantly think about the little yet big details of a product. They also (ideally) should have experience in building different kinds of products and understand not only how it's designed, but also how it's made (technically).

***An engineer*** This person needs to be incredibly skilled in engineering, and should ideally be an experienced CTO. They should know how to hire engineers, how to define a scalable architecture, how to build up a strong engineering culture — and how to build a maintainable product.
...
***A business/finance person*** Having a financial mastermind is an incredible asset, and reduces the risk of making financial mistakes in the beginning enormously (e.g. agreeing to the wrong investment terms). I would never start a company again without having someone taking over that role.
...
When it comes to equity, be fair. Everyone should invest the same energy and the same amount of time. Also think about your first employees, it's normal to let employees participate in the companies financial success by giving away virtual stock options (I will talk about that more next in the next part of this series). Make sure you hire an experienced lawyer for setting up the company. If you decide to start your business in Berlin, I can recommend working with [Lacore](http://www.lacore.de/), but feel free to [search for "Laywer" in the Berlin Startups group](https://www.facebook.com/groups/159595270791268/search/?query=lawyer).

##### 10. Raise your first round of money, or bootstrap your company

There are two ways of starting a tech business. You either do it on your own, taking all risks and responsibilities yourself ("bootstrapping"), or you find investors that believe in your company. Both ways are great, I've tried both, but personally I wouldn't try to start something again without partners. Wunderlist is the first business I secured the interest of experienced investors, including [Atomico](http://www.atomico.com/), [Earlybird](http://www.earlybird.com/), [Sequoia](https://www.sequoiacap.com/) & [Thrive](http://www.thrivecap.com/). They've worked with hundreds of entrepreneurs, and built huge tech companies themselves, and I wouldn't be where I am without them.
...
When you start your first tech business, avoid the common mistakes. Don't pitch too early, and don't pitch to world-class venture capitalists before you are ready. Prepare a working prototype, showcase the product you actually want to build, or at least demonstrate that you are able to build it. If you want to get an investor on board, try to understand what investors care about — it's mainly the team and the product. Most first-time entrepreneurs write huge business plans, instead of creating a [short pitch-deck](http://techcrunch.com/2012/01/07/pitchdeck/). Focus on building a prototype, test your business model and create a clear strategy to become a sustainable and scaleable business fast. Talk to investors when you are ready, not when you have something on paper — build up your story.

Before you start talking to large VCs, find some early stage investors. Stefan Tirtey, created this document with [Berlin early stage investors](https://docs.google.com/a/6wunderkinder.com/spreadsheet/ccc?key=0AmDAswEZV7PGdFlYQzhXWGhjNUI3Y0pFaUhMTVF1a2c&hl=de#gid=0).

If you raise money for the first time, you better understand the basics of venture capital. [Brad Feld](http://feld.com/) wrote a great book about [Venture Capital](http://www.amazon.de/Venture-Deals-Smarter-Lawyer-Capitalist/dp/1118443616). Still, raising money for the first time is difficult.
...
*Be generous with shares to your employees, they are your capital and most important resource. But never give away shares without clear* *[vesting](http://thestartuptoolkit.com/blog/2013/02/equity-basics-vesting-cliffs-acceleration-and-exits/)* *rules.*
...
Fred Wilson wrote about this [phenomenon](http://www.avc.com/a_vc/2013/08/mba-mondays-turning-your-team.html):
...
There is an insanely good article written by Ben Horowitz, that I recommend every founder read, both in hard and in good times — it's [What's The Most Difficult CEO Skill? Managing Your Own Psychology](http://bhorowitz.com/2011/04/01/what%E2%80%99s-the-most-difficult-ceo-skill-managing-your-own-psychology/).

Being a manager and being a founder are two different things. You need to learn this very quickly. A founder often sets the tone, the mission, the speed, the ethic, the culture. Being a founder — a programmer, or a designer, or a salesperson — requires a totally different skill set than being a manager. Being a founder means to work — being a manager means to think. The job of a manager is to carefully make decisions, easy ones and tough ones. You need to define the business strategy, recruit people, build teams, motivate employees, set and measure goals, empower ownership, create partnerships, take care of financials etc. These skills are hard to develop, [many founders actually decide to hire a CEO at a later stage](http://techcrunch.com/2012/11/11/signs-it-might-be-time-to-consider-hiring-a-ceo/). Becoming a CEO is not for everyone, it's a huge challenge in addition to the challenges you already have as a business.
...
Becoming successful will change your personality, either in a positive, or in a negative way — it's your decision. When Steve Jobs got asked what his biggest weakness was, he answered: "[I think all of us need to be on guard against arrogance, which knocks on your door whenever your are successful](http://www.youtube.com/watch?v=ZUfzXz23ndo#t=3m5s)." For myself I found that through being honest and transparent and sharing my knowledge I am getting a lot back every single day. Work hard, take risks — and always be nice to people.

(*Originally published at* *[christianreber.com](http://christianreber.com/blog/our-vision-of-wunderlist)* *in 2013)*
