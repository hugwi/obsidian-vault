...
![rw-book-cover](https://images.ctfassets.net/kftzwdyauwt9/2TjayW57xam6dBbbV28sae/887861e21b8d205c2c392ec5315d3681/SEO.png?w=1600&h=900&fit=fill)

## Metadata
- Author: [[openai.com]]
- Full Title: Harness engineering: leveraging Codex in an agent-first world | OpenAI
- Category: #articles
- Summary: OpenAI's team built software using only Codex-generated code, with no manual coding. Engineers now focus on guiding and improving agents to do reliable work. This new approach changes how software is designed, reviewed, and maintained at scale.
