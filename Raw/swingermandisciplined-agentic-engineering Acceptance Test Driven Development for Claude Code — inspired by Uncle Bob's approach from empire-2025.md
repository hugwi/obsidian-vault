...
![rw-book-cover](https://repository-images.githubusercontent.com/1159560676/988de84d-38dc-40fb-8d64-3e7f54dfb299)

## Metadata
- Author: [[https://github.com/swingerman/]]
- Full Title: swingerman/disciplined-agentic-engineering: Acceptance Test Driven Development for Claude Code — inspired by Uncle Bob's approach from empire-2025
- Category: #articles
- Summary: This project provides a disciplined method called Disciplined Agentic Engineering (DAE) that uses Acceptance Test Driven Development (ATDD), mutation testing, and strict verification to guide AI coding safely. It breaks features into clear, human-reviewed steps with tests and architecture plans to keep AI changes correct and controlled. The tools and plugins help software engineers manage AI coding like writing specs, running tests, and checking code quality.
- URL: https://github.com/swingerman/disciplined-agentic-engineering

## Full Document
[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/swingerman/disciplined-agentic-engineering?resume=1) 
...
[![License: MIT](https://camo.githubusercontent.com/08cef40a9105b6526ca22088bc514fbfdbc9aac1ddbf8d4e6c750e3a88a44dca/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4c6963656e73652d4d49542d626c75652e737667)](https://github.com/swingerman/disciplined-agentic-engineering/blob/master/LICENSE)
[![Claude Code Marketplace](https://camo.githubusercontent.com/de4cc35c93c393b6682dd7487ff9610d7a754e762ef4afc4f4aec29ca4fbf8a7/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f436c61756465253230436f64652d4d61726b6574706c6163652d626c756576696f6c6574)](https://github.com/swingerman/disciplined-agentic-engineering)
...
| --- | --- | --- |
| **[`engineer`](https://github.com/swingerman/disciplined-agentic-engineering/blob/master/engineer)** | The DAE methodology kit — feature intake, AC discovery, spec writing, planning, refinement, verification, hardening. Ships the deterministic guardrail scripts (`dae_*.py`) every checkpoint depends on. | v0.10 — pipeline shipped |
| **[`atdd`](https://github.com/swingerman/disciplined-agentic-engineering/blob/master)** | Acceptance Test Driven Development workflow with team orchestration, **differential mutation testing**, and the portable Gherkin pipeline. | v0.8 — stable |
| **[`crap-analyzer`](https://github.com/swingerman/disciplined-agentic-engineering/blob/master/crap-analyzer)** | Change Risk Anti-Pattern analysis on changed code; part of DAE's Light Verify (Checkpoint 7). | v0.1 |
...
>  **Migrating from the legacy `;=== .txt` format?** Run `dae_gherkin_convert.py specs/feature.txt features/NNN-slug/spec.md` (in the `engineer` plugin's `scripts/`). The `.txt` format is deprecated.
> 
>  
...
[MIT](https://github.com/swingerman/disciplined-agentic-engineering/blob/master/LICENSE)
