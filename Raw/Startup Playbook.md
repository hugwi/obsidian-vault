...
![rw-book-cover](https://playbook.samaltman.com/img/facebook.png)

## Metadata
- Author: [[Sam Altman]]
- Full Title: Startup Playbook
- Category: #articles
- Summary: Startups must make something a small number of users love and then scale from there. Great startups need a strong idea, a focused team, excellent product execution, and relentless learning. Founders must recruit well, stay committed without being stubborn, and talk to users constantly.
