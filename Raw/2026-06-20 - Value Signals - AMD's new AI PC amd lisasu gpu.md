...
![AMD's new AI PC #amd #lisasu #gpu](https://www.youtube.com/embed/V-0JaW7cnow)
...
[applause and music] >> Now, I would say this is pretty beautiful. Do you guys agree? So, let me tell you what it is. This is the smallest AI development system in the world. Capable of running models with up to 200 billion parameters locally, not connected [music] to anything. It's powered by our highest-end Ryzen AI Max processor with 128 GB [music] of high-speed unified memory that is shared by CPU, GPU, and NPU. >> [music] >> This architecture accelerates system performance and makes it possible to efficiently run large AI models [music] on a compact desktop PC that fits in your hand. >> [music]
