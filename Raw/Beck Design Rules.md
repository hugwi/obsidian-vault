...
![rw-book-cover](https://martinfowler.com/bliki/images/beckDesignRules/sketch.png)

## Metadata
- Author: [[Martin Fowler]]
- Full Title: Beck Design Rules
- Category: #articles
- Summary: Kent Beck's four rules of simple design prioritize passing tests, clear intent, no duplication, and minimal elements in code. These rules help create better, easier-to-understand software that works correctly. They are simple to remember and improve code quality across different programming styles.
...
![](https://martinfowler.com/bliki/images/beckDesignRules/kent.jpg)  Kent Beck developed Extreme Programming, Test Driven Development, and can always be relied on for good Victorian facial hair for his local ballet. 
...
* [J.B. Rainsberger's summary](http://www.jbrains.ca/permalink/the-four-elements-of-simple-design). He also has a good discussion of [the interplay between the rules 2&3.](http://blog.thecodewhisperer.com/2013/12/07/putting-an-age-old-battle-to-rest/)
* These rules, like much else of Extreme Programming, were originally discussed and refined [on Ward's Wiki](http://c2.com/cgi/wiki?XpSimplicityRules).
