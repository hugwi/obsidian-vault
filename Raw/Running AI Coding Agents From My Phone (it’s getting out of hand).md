...
![rw-book-cover](https://miro.medium.com/v2/da:true/bc1f8416df0cad099e43cda2872716e5864f18a73bda2a7547ea082aca9b5632)

## Metadata
- Author: [[Alexei Ledenev]]
- Full Title: Running AI Coding Agents From My Phone (it’s getting out of hand)
- Category: #articles
- Summary: Alexei Ledenev built CCGram, a Telegram bot that lets him control AI coding agents on his phone via tmux sessions. This tool helps him manage multiple coding tasks remotely, making coding happen anytime, even when he’s away from his desk. CCGram has voice input, session alerts, and works with different AI agents, increasing his productivity but also making him always reachable.
- URL: https://itnext.io/running-ai-coding-agents-from-my-phone-its-getting-out-of-hand-7149bcabd82f
