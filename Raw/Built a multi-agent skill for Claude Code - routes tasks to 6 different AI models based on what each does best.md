...
## Metadata
- Author: [[Past-Ad-6215]]
- Full Title: Built a multi-agent skill for Claude Code - routes tasks to 6 different AI models based on what each does best
- Category: #articles
- Summary: The author built a Claude Code skill called OmO that routes tasks to six different AI models based on their strengths. This skill helps choose the best model for tasks like coding, research, or design automatically. The skill is free, open source, and uses Claude's ability to understand task needs for smart routing.
- URL: https://www.reddit.com/r/ClaudeAI/comments/1qgxzbb/built_a_multiagent_skill_for_claude_code_routes/?share_id=_Wj3bfzYPqTEn3YCmGd3l&utm_content=2&utm_medium=android_app&utm_name=androidcss&utm_source=share&utm_term=1
