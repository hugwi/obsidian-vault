...
## Metadata
- Author: [[Scrum Master]]
- Full Title: Understanding Epics, Features, And User Stories
- Category: #articles
- Summary: Epics are large, high-level bodies of work spanning releases that get broken into smaller pieces. Features group related user stories, fit within a release, and deliver testable business value. User stories are small, sprint-sized tasks with clear acceptance criteria for developers to implement.
- URL: https://scrumdistrict.com/understanding-epics-features-and-user-stories/
