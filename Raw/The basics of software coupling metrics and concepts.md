...
![rw-book-cover](https://cdn.ttgtmedia.com/visuals/searchTelecom/network_operations/telecom_article_007.jpg)

## Metadata
- Author: [[Joydip Kanjilal]]
- Full Title: The basics of software coupling metrics and concepts
- Category: #articles
- Summary: Coupling measures how many dependencies exist between software components. Cohesion measures how related the internal parts of a component are. Metrics like afferent/efferent coupling, instability, and abstractness help architects design modular, maintainable systems.
