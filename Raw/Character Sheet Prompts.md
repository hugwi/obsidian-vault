...
### Next useful steps (your call)

I can:

compress these into Nano Banana–optimized short prompts

create a tight negative prompt block

build a stress-test prompt to validate realism

or adapt this for video identity continuity
