...
# People around you're not doing their job

#### **Recognize What’s in Your Control and What Isn’t**
https://maybusch.com/when-people-around-you-doing-bad-job/

#### **Create Your Support System**

https://timeular.com/blog/how-deal-lazy-coworkers/
...
There are several [reasons they’re feeling and being unproductive](https://timeular.com/blog/the-real-reason-people-are-unproductive-isnt-what-you-think/). They may be going through complicated personal issues and worried about their families for some reason. They may be having money problems, or they may be burned out.
...
https://www.linkedin.com/pulse/what-do-when-someones-doing-part-maxine-nwaneri/
Once you realise this situation is happening FOR you, you ask better questions of yourself. Like “how can I avoid this happening again?” In my case, it was questions liked “how can I become a better leader to stop this happening again?” and “What do I need to change?”

https://www.nsls.org/blog/leading-difficult-people
### 1. Start by identifying the root cause

According to [The Society of Human Resource Management (SHRM)](https://www.shrm.org/hr-today/news/hr-magazine/0217/pages/how-do-you-deal-with-difficult-people.aspx), one of the best ways to begin leading a difficult person is to understand the root cause of the problem. Most people don’t want to be viewed as difficult, meaning there is likely something going on that’s been overlooked.
...
Uncovering the root cause of these behaviors requires a leader to foster a culture of openness and transparency where problems are not pushed to the side. One of the best leadership styles for this is [servant leadership](https://www.nsls.org/blog/what-is-servant-leadership-and-how-to-apply-it#:~:text=Servant%20leadership%20is%20a%20style,to%20be%20connected%20to%20you.), which hinges on putting the needs of others first and focuses on being an active listener.
...
Other tips for making sure the [communication process](https://www.nsls.org/blog/success-through-resilience-and-clear-communication) goes smoothly:
...
**3.** Next, you need to understand that those around you; your friends; your colleagues; or if you are in a relationship, your partner; are not your journal.

Instead, find a healthy way to process it yourself, perhaps through an actual journal, or with a coach with the goal of getting through it quickly, and finding the best way forward.

**4.** Finally you can change your state.
One of the ways to do that is to journal, if you combine with tip 2 above, you can complete both steps in a single move. 

After my infuriating experience, I had a good ten-minute journal, and I emerged so much more grateful and with such fierceness and excitement about what it is I am going to do and create. A much better state that I started.

**5.** The final thing to take onboard is to approach the person who is not meeting your expectations with love.
...
With that in mind, the first thing to do when faced with a challenging person [is to look inside](https://www.betterup.com/blog/coaching-power-of-reflection). Understanding why you’re affected by them can help you determine the best way to handle their behavior.
...
Sometimes, we get into difficult conversations because we take things too seriously. If you’re in conflict with another person, [using (appropriate) humor can help diffuse tension](https://www.betterup.com/blog/humor-in-the-workplace). Cracking a joke — or even a smile — can help lower the stakes. It can remind you of shared common ground and even shift you into a more collaborative mood.
...
### Reason for being unprodctive
https://timeular.com/blog/the-real-reason-people-are-unproductive-isnt-what-you-think/
